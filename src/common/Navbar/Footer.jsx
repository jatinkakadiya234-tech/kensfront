    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent, rgba(79, 172, 254, 0.5), transparent)",
          }}
        />
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto max-w-3xl w-full rounded-lg bg-white p-6 max-h-[90vh] overflow-y-auto shadow-xl">
            ...
            <div className="text-base text-gray-700 space-y-4 pr-4">
              ...
              <p>
                Welcome to CloudDrive! These Terms and Conditions ("Terms")
                govern your use of our cloud storage services, accessible at
                https://clouddrive.example.com. By using our platform, you agree
              ...
              <section className="pt-2">
                ...
                <p>
                  By accessing or using CloudDrive, you confirm that you are at
                  least 13 years old and have the legal capacity to enter into a
                  binding agreement. If you are using the service on behalf of
              ...
              <section className="pt-2">
                ...
                <p>
                  CloudDrive offers secure file hosting, sharing, and cloud
                  storage services. We reserve the right to update, modify, or
                  discontinue any feature or service without prior notice.
                </p>
              </section>
              ...
              <section className="pt-2">
                ...
                <ul className="list-disc pl-5 space-y-1 mt-2">
                  <li>
                    You will not upload or share illegal, harmful, or
                    copyrighted content without permission.
                  </li>
                  <li>
                    You are solely responsible for the content you upload or
                    share.
                  </li>
                  <li>
                    You will not use our service to distribute viruses, malware,
              ...
              <section className="pt-2">
                ...
                <p className="mt-2">
                  We may suspend or terminate your account if we believe it's
              ...
              <section className="pt-2">
                ...
                <p>
                  You retain ownership of any content you upload to CloudDrive.
                </p>
                <p>
                  By uploading content, you grant us a non-exclusive,
                  royalty-free license to host and deliver your files for the
                  purpose of providing the service.
                </p>
                <p>
                  We do not claim ownership of your content and will not use it
                  for any purpose beyond service functionality.
                </p>
              </section>
              ...
              <section className="pt-2">
                ...
                <p>
                  CloudDrive is provided "as is" and "as available." We do not
              ...
              <section className="pt-2">
                ...
                <p>
                  ...
                  any time, without notice, for any reason, including violation
                  of these Terms.
                </p>
                <p>
                  You may stop using the service at any time. Content may be
              ...
              <section className="pt-2">
                ...
                <p>
                  ...
                  here with an updated "Effective Date." Continued use of the
              ...
              <section className="pt-2">
                ...
                <p>
                  ...
                  disputes must be filed in the courts of that jurisdiction.
                </p>
              </section>
              <section className="pt-2">
                <h2 className="font-bold text-lg text-gray-800">
                  10. Onetime Premium Access
                </h2>
                <p>
                  If you purchase a one-time premium plan, your access will
                  remain valid for a lifetime without any recurring payments.
                </p>
              </section>
              ...
              <section className="pt-2">
                ...
                <p>
                  CloudDrive Support
                  <br />
                  Email: support@clouddrive.example.com
                </p>
              </section>
            </div>
          </Dialog.Panel>
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto max-w-3xl w-full rounded-lg bg-white p-6 max-h-[90vh] overflow-y-auto shadow-xl">
            ...
            <div
              className="text-base text-gray-700 space-y-4 pr-4"
